...
def main():
    ...
    fidelity_args = [props, fidelity_tolerance,reward_decay, True] #[dt, props, True] #[props,fidelity_tolerance,reward_decay, True] #[dt,props,speed_fraction, max_optimization_time]#,fidelity_tolerance,reward_decay]
